  ...
  const timeLinedata = [
    {
      ...
      description:
        "Developed an admin dashboard to manage restaurant operations, track orders, and update menus efficiently.",
      image: palatoFav,
    ...
    },
    {
      ...
      description:
        "Created a POS system for processing sales, managing inventory, and generating business reports.",
      image: nailaLogo,
      mlh: "https://s3.amazonaws.com/logged-assets/trust-badge/2019/mlh-trust-badge-2019-white.svg",
      links: [],
    },
    {
      ...
      description:
        "Designed a landing page to showcase the brand's services, attract customers, and boost online presence.",
      image: brandrscoLogo,
      mlh: "https://s3.amazonaws.com/logged-assets/trust-badge/2019/mlh-trust-badge-2019-white.svg",
      links: [],
    },
              ...
              <div className="space-y-2 text-start sm:text-center">
                ...
                <BlurFade delay={0.35} inView>
                  <p className="text-[15px] sm:text-[16px] text-gray-700">
                    ...
                    building innovative web apps, including e-commerce
                    platforms, POS systems, small-scale tools, and responsive
                    landing pages.
                  </p>
                </BlurFade>
              </div>
